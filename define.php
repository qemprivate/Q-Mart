...
define('DOMAIN', 'YOUR_DOMAIN'); // Domain name: (eg. 'www.example.com')

/* Do not change anything below this line, unsless you know what you're dowing. */

define('PROTOCOL', 'http://');
define('HTTP_SERVER', PROTOCOL . DOMAIN);
define('IMAGE_SERVER', HTTP_SERVER);
