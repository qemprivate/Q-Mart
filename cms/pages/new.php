      ...
      <div id="div-1" class="accordion-body collapse in body">
        <form action="functions/add_product.php" method="post" class="form-horizontal" enctype="multipart/form-data" data-parsley-validate>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <select name="newused" class="form-control chzn-select" tabindex="2" required>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" name="oprice" placeholder="150" class="form-control" data-parsley-type="number" required>
            </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" name="nprice" placeholder="125" class="form-control" data-parsley-type="number" required>
            </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" name="availability" placeholder="35" class="form-control" data-parsley-type="digits" required>
            </div>
          </div><!-- /.form-group -->
