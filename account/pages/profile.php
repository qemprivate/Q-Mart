  ...
  <div class="col-lg-8">
    <div class="box dark">
      ...
      <div id="div-1" class="accordion-body collapse in body">
        <form action="functions/update_profile.php" method="post" class="form-horizontal" data-parsley-validate>

          <div class="form-group">
            <label for="text1" class="control-label col-lg-4">Username</label>
            <div class="col-lg-8">
              <input type="text" id="username" name="username" placeholder="Enter Your Username" class="form-control" value="<?php echo $row['username']; ?>">
            </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" id="address" name="address" placeholder="Enter Your Address" class="form-control" value="<?php echo $row['address']; ?>">
            </div>
          </div><!-- /.form-group -->
